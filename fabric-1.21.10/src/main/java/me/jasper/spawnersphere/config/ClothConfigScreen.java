...
import me.jasper.spawnersphere.common.config.IConfigScreen;
...
public class ClothConfigScreen implements IConfigScreen {
    ...
    public boolean isAvailable() {
        try {
            ...
            // Catch exceptions that Class.forName() can throw
            // Note: ExceptionInInitializerError extends LinkageError, so it's already covered
            return false;
        }
    }
}
